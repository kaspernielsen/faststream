...
/**
 * A test step for {@link Map#get(Object)}.
 * 
 * @param <K>
 ...
 */
public class Get<K, V> extends AbstractRandomMapTestCase<K, V> {
    ...
    public void getIncompatibleKey() {
        assumeIncompatibleKeysExist();

        actual().get(incompatibleKeys().get());
    }
}
