...
/**
 * Test the {@link Stream#filter(Predicate)} method.
 * 
 * @param <E>
 ...
 */
public class Filter extends AbstractRandomIntStreamTestCase {

    @RndTest
    public void filter() {
        HashcodeModPredicate<Integer> p = new HashcodeModPredicate<>(random().nextInt(1, 12));
