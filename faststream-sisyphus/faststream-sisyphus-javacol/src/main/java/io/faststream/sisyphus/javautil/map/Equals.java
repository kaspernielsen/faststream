...
/**
 * A test step for {@link Map#equals(Object)}.
 * 
 * @param <K>
 ...
 */
public class Equals<K, V> extends AbstractRandomMapTestCase<K, V> {

    @RndTest
    @LifecycleTestMethod(false)
    public void equals() {
        assertTrue(actual().equals(actual()));
        assertTrue(actual().equals(expected().map));
        assertFalse(actual().equals(null));
        assertFalse(actual().equals(123));
    }
}
