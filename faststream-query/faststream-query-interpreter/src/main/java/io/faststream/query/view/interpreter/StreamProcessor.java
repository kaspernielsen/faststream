...
import io.faststream.query.db.nodes.stream.stream.SOT_AllMatch;
import io.faststream.query.db.nodes.stream.stream.SOT_AnyMatch;
import io.faststream.query.db.nodes.stream.stream.SOT_Collect;
import io.faststream.query.db.nodes.stream.stream.SOT_CollectSupplier;
import io.faststream.query.db.nodes.stream.stream.SOT_Count;
import io.faststream.query.db.nodes.stream.stream.SOT_FindAny;
import io.faststream.query.db.nodes.stream.stream.SOT_FindFirst;
import io.faststream.query.db.nodes.stream.stream.SOT_ForEach;
import io.faststream.query.db.nodes.stream.stream.SOT_ForEachOrdered;
import io.faststream.query.db.nodes.stream.stream.SOT_Iterator;
import io.faststream.query.db.nodes.stream.stream.SOT_MaxComparator;
import io.faststream.query.db.nodes.stream.stream.SOT_MinComparator;
import io.faststream.query.db.nodes.stream.stream.SOT_NoneMatch;
import io.faststream.query.db.nodes.stream.stream.SOT_Reduce;
import io.faststream.query.db.nodes.stream.stream.SOT_ReduceCombiner;
import io.faststream.query.db.nodes.stream.stream.SOT_Spliterator;
import io.faststream.query.db.nodes.stream.stream.SOT_ToArray;
import io.faststream.query.db.nodes.stream.stream.SOT_ToArrayFunction;
import io.faststream.query.db.nodes.stream.stream.SO_Distinct;
import io.faststream.query.db.nodes.stream.stream.SO_Filter;
import io.faststream.query.db.nodes.stream.stream.SO_FlatMap;
import io.faststream.query.db.nodes.stream.stream.SO_FlatMapToDouble;
import io.faststream.query.db.nodes.stream.stream.SO_FlatMapToInt;
import io.faststream.query.db.nodes.stream.stream.SO_FlatMapToLong;
import io.faststream.query.db.nodes.stream.stream.SO_Limit;
import io.faststream.query.db.nodes.stream.stream.SO_Map;
import io.faststream.query.db.nodes.stream.stream.SO_MapToDouble;
import io.faststream.query.db.nodes.stream.stream.SO_MapToInt;
import io.faststream.query.db.nodes.stream.stream.SO_MapToLong;
import io.faststream.query.db.nodes.stream.stream.SO_Parallel;
import io.faststream.query.db.nodes.stream.stream.SO_Peek;
import io.faststream.query.db.nodes.stream.stream.SO_Sequential;
import io.faststream.query.db.nodes.stream.stream.SO_Skip;
import io.faststream.query.db.nodes.stream.stream.SO_SortedAscending;
import io.faststream.query.db.nodes.stream.stream.SO_SortedComparator;
import io.faststream.query.db.nodes.stream.stream.SO_Unordered;
import io.faststream.query.db.nodes.stream.stream.StreamVisitable;
