...
import io.faststream.query.db.nodes.stream.longstream.LongStreamVisitable;
import io.faststream.query.db.nodes.stream.longstream.SLT_AllMatch;
import io.faststream.query.db.nodes.stream.longstream.SLT_AnyMatch;
import io.faststream.query.db.nodes.stream.longstream.SLT_Average;
import io.faststream.query.db.nodes.stream.longstream.SLT_Collect;
import io.faststream.query.db.nodes.stream.longstream.SLT_Count;
import io.faststream.query.db.nodes.stream.longstream.SLT_FindAny;
import io.faststream.query.db.nodes.stream.longstream.SLT_FindFirst;
import io.faststream.query.db.nodes.stream.longstream.SLT_ForEach;
import io.faststream.query.db.nodes.stream.longstream.SLT_ForEachOrdered;
import io.faststream.query.db.nodes.stream.longstream.SLT_Iterator;
import io.faststream.query.db.nodes.stream.longstream.SLT_Max;
import io.faststream.query.db.nodes.stream.longstream.SLT_Min;
import io.faststream.query.db.nodes.stream.longstream.SLT_NoneMatch;
import io.faststream.query.db.nodes.stream.longstream.SLT_Reduce;
import io.faststream.query.db.nodes.stream.longstream.SLT_Spliterator;
import io.faststream.query.db.nodes.stream.longstream.SLT_Sum;
import io.faststream.query.db.nodes.stream.longstream.SLT_SummaryStatistics;
import io.faststream.query.db.nodes.stream.longstream.SLT_ToArray;
import io.faststream.query.db.nodes.stream.longstream.SL_AsDoubleStream;
import io.faststream.query.db.nodes.stream.longstream.SL_Boxed;
import io.faststream.query.db.nodes.stream.longstream.SL_Distinct;
import io.faststream.query.db.nodes.stream.longstream.SL_Filter;
import io.faststream.query.db.nodes.stream.longstream.SL_FlatMap;
import io.faststream.query.db.nodes.stream.longstream.SL_Limit;
import io.faststream.query.db.nodes.stream.longstream.SL_Map;
import io.faststream.query.db.nodes.stream.longstream.SL_MapToDouble;
import io.faststream.query.db.nodes.stream.longstream.SL_MapToInt;
import io.faststream.query.db.nodes.stream.longstream.SL_MapToObj;
import io.faststream.query.db.nodes.stream.longstream.SL_Parallel;
import io.faststream.query.db.nodes.stream.longstream.SL_Peek;
import io.faststream.query.db.nodes.stream.longstream.SL_Sequential;
import io.faststream.query.db.nodes.stream.longstream.SL_Skip;
import io.faststream.query.db.nodes.stream.longstream.SL_Sorted;
import io.faststream.query.db.nodes.stream.longstream.SL_Unordered;
