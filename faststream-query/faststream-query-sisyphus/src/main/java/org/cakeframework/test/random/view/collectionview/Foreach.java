...
/**
 * Test the {@link CollectionView#apply(Consumer)} operation.
 * <p>
 * Basic idea is to throw to all arguments to {@link Consumer#accept(Object)} into a concurrent queue and compare with
 * expected contents.
 *
 * @param <E>
 ...
 */
public class Foreach<E> extends AbstractCollectionViewRandomTestCase<E> {
    ...
    static class ConcurrentQueueAllowingNull<V> implements Consumer<V> {
