...
import static io.faststream.query.db.query.node.defaults.MapQueryOperations.M_VIEW_KEYS;
import static io.faststream.query.db.query.node.defaults.MultimapOperations.U;
import static io.faststream.query.db.query.node.defaults.MultimapOperations.U_ANY;
import static io.faststream.query.db.query.node.defaults.MultimapOperations.U_COUNT;
import static io.faststream.query.db.query.node.defaults.MultimapOperations.U_FIRST;
import static io.faststream.query.db.query.node.defaults.MultimapOperations.U_LAST;
import static io.faststream.query.db.query.node.defaults.MultimapOperations.U_VIEW_KEYS;
