...
public class SL_MapToObj extends AbstractStream implements LongStreamVisitable {

    private static final long serialVersionUID = 1L;

    private final LongFunction mapper;

    public SL_MapToObj(QueryOperationNode parent, StreamContext context, LongFunction mapper) {
    ...
    public QueryOperationNodeDefinition getOperationPackage() {
        return QueryOperationNodeDefinition.create(CollectionQueryOperations.C_MAP_TO_OBJECT, "mapper", LongFunction.class);
    }
