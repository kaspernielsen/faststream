...
public class SIT_FindFirst extends TerminalQueryOperationNode implements IntStreamVisitable {

    private static final long serialVersionUID = 1L;

    public SIT_FindFirst(QueryOperationNode parent, StreamContext context) {
        super(parent);
        context.consume();
    }
