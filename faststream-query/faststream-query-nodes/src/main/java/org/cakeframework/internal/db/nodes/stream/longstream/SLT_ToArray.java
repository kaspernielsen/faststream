...
public class SLT_ToArray extends TerminalQueryOperationNode implements LongStreamVisitable {

    private static final long serialVersionUID = 1L;

    public SLT_ToArray(QueryOperationNode parent, StreamContext context) {
        super(parent);
        context.consume();
    }
