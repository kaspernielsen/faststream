...
public class SOT_Reduce extends TerminalQueryOperationNode implements StreamVisitable {

    private static final long serialVersionUID = 1L;

    private final BinaryOperator accumulator;

    public SOT_Reduce(QueryOperationNode parent, StreamContext context, BinaryOperator accumulator) {
        super(parent);
    ...
    public QueryOperationNodeDefinition getOperationPackage() {
        return QueryOperationNodeDefinition.create(CollectionQueryOperations.CT_REDUCE_OPERATOR, "accumulator", BinaryOperator.class);
    }
    ...
    public BinaryOperator getAccumulator() {
        return accumulator;
    }
