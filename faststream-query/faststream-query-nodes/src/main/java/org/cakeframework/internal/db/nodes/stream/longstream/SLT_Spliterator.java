...
public class SLT_Spliterator extends TerminalQueryOperationNode implements LongStreamVisitable {

    private static final long serialVersionUID = 1L;

    public SLT_Spliterator(QueryOperationNode parent, StreamContext context) {
        super(parent);
        context.consume();
    }
