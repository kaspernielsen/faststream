...
public class SL_Sequential extends AbstractLongStream implements LongStreamVisitable {

    private static final long serialVersionUID = 1L;

    public SL_Sequential(QueryOperationNode parent, StreamContext context) {
