...
public class SIT_SummaryStatistics extends TerminalQueryOperationNode implements IntStreamVisitable {

    private static final long serialVersionUID = 1L;

    public SIT_SummaryStatistics(QueryOperationNode parent, StreamContext context) {
        super(parent);
        context.consume();
    }
