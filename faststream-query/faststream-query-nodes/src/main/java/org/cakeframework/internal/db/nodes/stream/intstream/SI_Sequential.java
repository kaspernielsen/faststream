...
public class SI_Sequential extends AbstractIntStream implements IntStreamVisitable {

    private static final long serialVersionUID = 1L;

    public SI_Sequential(QueryOperationNode parent, StreamContext context) {
