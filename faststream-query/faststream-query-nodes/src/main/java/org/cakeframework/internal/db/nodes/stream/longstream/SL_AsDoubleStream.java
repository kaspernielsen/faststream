...
public class SL_AsDoubleStream extends AbstractDoubleStream implements LongStreamVisitable {

    private static final long serialVersionUID = 1L;

    public SL_AsDoubleStream(QueryOperationNode parent, StreamContext context) {
        super(parent, context);
        context.checkNotConsumed();
    }

    public QueryOperationNodeDefinition getOperationPackage() {
        return QueryOperationNodeDefinition.create(CollectionQueryOperations.C_AS_DOUBLE_STREAM);
    }
