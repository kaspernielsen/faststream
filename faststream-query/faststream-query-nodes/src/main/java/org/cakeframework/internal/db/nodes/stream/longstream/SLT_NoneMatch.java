...
public class SLT_NoneMatch extends TerminalQueryOperationNode implements LongStreamVisitable {

    private static final long serialVersionUID = 1L;

    private final LongPredicate longPredicate;

    public SLT_NoneMatch(QueryOperationNode parent, StreamContext context, LongPredicate longPredicate) {
        super(parent);
    ...
    public QueryOperationNodeDefinition getOperationPackage() {
        return QueryOperationNodeDefinition.create(CollectionQueryOperations.CT_MATCH_NONE, "longPredicate", LongPredicate.class);
    }
