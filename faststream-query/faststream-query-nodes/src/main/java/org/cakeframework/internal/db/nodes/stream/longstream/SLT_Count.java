...
public class SLT_Count extends TerminalQueryOperationNode implements LongStreamVisitable {

    private static final long serialVersionUID = 1L;

    public SLT_Count(QueryOperationNode parent, StreamContext context) {
        super(parent);
        context.consume();
    }
