...
public class SO_Filter extends AbstractStream implements StreamVisitable {

    private static final long serialVersionUID = 1L;

    private final Predicate predicate;

    public SO_Filter(QueryOperationNode parent, StreamContext context, Predicate predicate) {
