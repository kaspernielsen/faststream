...
public class SD_Skip extends AbstractDoubleStream implements DoubleStreamVisitable {

    private static final long serialVersionUID = 1L;

    private final long n;

    public SD_Skip(QueryOperationNode parent, StreamContext context, long n) {
