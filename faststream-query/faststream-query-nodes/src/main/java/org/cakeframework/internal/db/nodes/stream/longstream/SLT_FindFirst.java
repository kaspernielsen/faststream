...
public class SLT_FindFirst extends TerminalQueryOperationNode implements LongStreamVisitable {

    private static final long serialVersionUID = 1L;

    public SLT_FindFirst(QueryOperationNode parent, StreamContext context) {
        super(parent);
        context.consume();
    }
