...
public class SOT_FindFirst extends TerminalQueryOperationNode implements StreamVisitable {

    private static final long serialVersionUID = 1L;

    public SOT_FindFirst(QueryOperationNode parent, StreamContext context) {
        super(parent);
        context.consume();
    }
