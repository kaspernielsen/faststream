...
public class SL_Limit extends AbstractLongStream implements LongStreamVisitable {

    private static final long serialVersionUID = 1L;

    private final long maxSize;

    public SL_Limit(QueryOperationNode parent, StreamContext context, long maxSize) {
