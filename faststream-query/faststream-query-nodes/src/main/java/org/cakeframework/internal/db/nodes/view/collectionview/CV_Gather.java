...
public class CV_Gather extends AbstractCollectionView implements CollectionViewVisitable {

    private static final long serialVersionUID = 1L;

    private final Supplier gatherer;

    public CV_Gather(QueryOperationNode parent, Supplier gatherer) {
        super(parent);
        this.gatherer = Objects.requireNonNull(gatherer, "gatherer is null");
    }

    public QueryOperationNodeDefinition getOperationPackage() {
        return QueryOperationNodeDefinition.create(CollectionQueryOperations.C_GATHER, "gatherer", Supplier.class);
    }
