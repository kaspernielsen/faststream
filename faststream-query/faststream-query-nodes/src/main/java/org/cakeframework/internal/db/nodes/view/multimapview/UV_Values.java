...
public class UV_Values extends AbstractCollectionView implements MultimapViewVisitable {

    private static final long serialVersionUID = 1L;

    public UV_Values(QueryOperationNode parent) {
        super(parent);
    }

    public QueryOperationNodeDefinition getOperationPackage() {
        return QueryOperationNodeDefinition.create(MultimapOperations.U_VIEW_VALUES);
    }
