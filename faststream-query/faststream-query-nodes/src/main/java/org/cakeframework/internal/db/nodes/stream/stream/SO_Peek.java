...
public class SO_Peek extends AbstractStream implements StreamVisitable {

    private static final long serialVersionUID = 1L;

    private final Consumer consumer;

    public SO_Peek(QueryOperationNode parent, StreamContext context, Consumer consumer) {
    ...
    public QueryOperationNodeDefinition getOperationPackage() {
        return QueryOperationNodeDefinition.create(CollectionQueryOperations.C_PEEK, "consumer", Consumer.class);
    }
