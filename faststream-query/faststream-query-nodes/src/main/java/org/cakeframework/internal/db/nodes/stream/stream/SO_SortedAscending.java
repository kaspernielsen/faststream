...
public class SO_SortedAscending extends AbstractStream implements StreamVisitable {

    private static final long serialVersionUID = 1L;

    public SO_SortedAscending(QueryOperationNode parent, StreamContext context) {
        super(parent, context);
        context.checkNotConsumed();
    }

    public QueryOperationNodeDefinition getOperationPackage() {
        return QueryOperationNodeDefinition.create(CollectionQueryOperations.C_SORTED_NATURAL);
    }
