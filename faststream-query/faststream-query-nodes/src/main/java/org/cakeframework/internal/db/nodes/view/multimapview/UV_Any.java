...
public class UV_Any extends AbstractMapView implements MultimapViewVisitable {

    private static final long serialVersionUID = 1L;

    public UV_Any(QueryOperationNode parent) {
        super(parent);
    }

    public QueryOperationNodeDefinition getOperationPackage() {
        return QueryOperationNodeDefinition.create(MultimapOperations.U_ANY);
    }
