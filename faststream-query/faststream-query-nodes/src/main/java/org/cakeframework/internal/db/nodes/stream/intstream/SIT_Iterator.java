...
public class SIT_Iterator extends TerminalQueryOperationNode implements IntStreamVisitable {

    private static final long serialVersionUID = 1L;

    public SIT_Iterator(QueryOperationNode parent, StreamContext context) {
        super(parent);
        context.consume();
    }
