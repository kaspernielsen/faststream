...
public class SLT_FindAny extends TerminalQueryOperationNode implements LongStreamVisitable {

    private static final long serialVersionUID = 1L;

    public SLT_FindAny(QueryOperationNode parent, StreamContext context) {
        super(parent);
        context.consume();
    }
