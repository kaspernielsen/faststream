...
public class UV_Map extends AbstractCollectionView implements MultimapViewVisitable {

    private static final long serialVersionUID = 1L;

    private final BiFunction mapper;

    public UV_Map(QueryOperationNode parent, BiFunction mapper) {
        super(parent);
        this.mapper = Objects.requireNonNull(mapper, "mapper is null");
    }

    public QueryOperationNodeDefinition getOperationPackage() {
        return QueryOperationNodeDefinition.create(MultimapOperations.U_MAP_BI, "mapper", BiFunction.class);
    }
