...
public class UV_One extends AbstractMapView implements MultimapViewVisitable {

    private static final long serialVersionUID = 1L;

    public UV_One(QueryOperationNode parent) {
        super(parent);
    }

    public QueryOperationNodeDefinition getOperationPackage() {
        return QueryOperationNodeDefinition.create(MultimapOperations.U_ONE);
    }
