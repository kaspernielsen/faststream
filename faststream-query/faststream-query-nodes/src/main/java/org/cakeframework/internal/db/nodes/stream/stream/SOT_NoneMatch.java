...
public class SOT_NoneMatch extends TerminalQueryOperationNode implements StreamVisitable {

    private static final long serialVersionUID = 1L;

    private final Predicate predicate;

    public SOT_NoneMatch(QueryOperationNode parent, StreamContext context, Predicate predicate) {
        super(parent);
    ...
    public QueryOperationNodeDefinition getOperationPackage() {
        return QueryOperationNodeDefinition.create(CollectionQueryOperations.CT_MATCH_NONE, "predicate", Predicate.class);
    }
