...
public class UV_Tail extends AbstractMapView implements MultimapViewVisitable {

    private static final long serialVersionUID = 1L;

    public UV_Tail(QueryOperationNode parent) {
        super(parent);
    }

    public QueryOperationNodeDefinition getOperationPackage() {
        return QueryOperationNodeDefinition.create(MultimapOperations.U_LAST);
    }
