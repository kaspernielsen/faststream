...
public class UVT_ToMultimap extends TerminalQueryOperationNode implements MultimapViewVisitable {

    private static final long serialVersionUID = 1L;

    public UVT_ToMultimap(QueryOperationNode parent) {
        super(parent);
    }

    public QueryOperationNodeDefinition getOperationPackage() {
        return QueryOperationNodeDefinition.create(MultimapOperations.UT_TO_MULTIMAP);
    }
