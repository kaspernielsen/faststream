...
public class SL_Unordered extends AbstractLongStream implements LongStreamVisitable {

    private static final long serialVersionUID = 1L;

    public SL_Unordered(QueryOperationNode parent, StreamContext context) {
