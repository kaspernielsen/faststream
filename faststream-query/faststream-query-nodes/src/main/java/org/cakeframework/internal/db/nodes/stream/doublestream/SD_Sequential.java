...
public class SD_Sequential extends AbstractDoubleStream implements DoubleStreamVisitable {

    private static final long serialVersionUID = 1L;

    public SD_Sequential(QueryOperationNode parent, StreamContext context) {
        super(parent, context);
        context.checkNotConsumed();
    }

    public QueryOperationNodeDefinition getOperationPackage() {
        return QueryOperationNodeDefinition.create(CollectionQueryOperations.C_SEQUENTIAL);
    }
