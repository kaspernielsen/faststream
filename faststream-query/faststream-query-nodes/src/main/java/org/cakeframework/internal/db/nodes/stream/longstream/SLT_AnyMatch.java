...
public class SLT_AnyMatch extends TerminalQueryOperationNode implements LongStreamVisitable {

    private static final long serialVersionUID = 1L;

    private final LongPredicate longPredicate;

    public SLT_AnyMatch(QueryOperationNode parent, StreamContext context, LongPredicate longPredicate) {
        super(parent);
    ...
    public QueryOperationNodeDefinition getOperationPackage() {
        return QueryOperationNodeDefinition.create(CollectionQueryOperations.CT_MATCH_ANY, "longPredicate", LongPredicate.class);
    }
