...
public class SLT_Average extends TerminalQueryOperationNode implements LongStreamVisitable {

    private static final long serialVersionUID = 1L;

    public SLT_Average(QueryOperationNode parent, StreamContext context) {
        super(parent);
        context.consume();
    }
