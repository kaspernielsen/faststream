...
public class SD_MapToInt extends AbstractIntStream implements DoubleStreamVisitable {

    private static final long serialVersionUID = 1L;

    private final DoubleToIntFunction mapper;

    public SD_MapToInt(QueryOperationNode parent, StreamContext context, DoubleToIntFunction mapper) {
    ...
    public QueryOperationNodeDefinition getOperationPackage() {
        return QueryOperationNodeDefinition.create(CollectionQueryOperations.C_MAP_TO_INT, "mapper", DoubleToIntFunction.class);
    }
