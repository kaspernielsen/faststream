...
public class SD_Filter extends AbstractDoubleStream implements DoubleStreamVisitable {

    private static final long serialVersionUID = 1L;

    private final DoublePredicate doublePredicate;

    public SD_Filter(QueryOperationNode parent, StreamContext context, DoublePredicate doublePredicate) {
    ...
    public QueryOperationNodeDefinition getOperationPackage() {
        return QueryOperationNodeDefinition.create(CollectionQueryOperations.C_FILTER, "doublePredicate", DoublePredicate.class);
    }
