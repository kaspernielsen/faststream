...
public class CVT_One extends TerminalQueryOperationNode implements CollectionViewVisitable {

    private static final long serialVersionUID = 1L;

    public CVT_One(QueryOperationNode parent) {
        super(parent);
    }

    public QueryOperationNodeDefinition getOperationPackage() {
        return QueryOperationNodeDefinition.create(CollectionQueryOperations.CT_ONE);
    }
