...
public class SI_Filter extends AbstractIntStream implements IntStreamVisitable {

    private static final long serialVersionUID = 1L;

    private final IntPredicate intPredicate;

    public SI_Filter(QueryOperationNode parent, StreamContext context, IntPredicate intPredicate) {
    ...
    public QueryOperationNodeDefinition getOperationPackage() {
        return QueryOperationNodeDefinition.create(CollectionQueryOperations.C_FILTER, "intPredicate", IntPredicate.class);
    }
