...
public class MV_Map extends AbstractCollectionView implements MapViewVisitable {

    private static final long serialVersionUID = 1L;

    private final BiFunction mapper;

    public MV_Map(QueryOperationNode parent, BiFunction mapper) {
        super(parent);
        this.mapper = Objects.requireNonNull(mapper, "mapper is null");
    }

    public QueryOperationNodeDefinition getOperationPackage() {
        return QueryOperationNodeDefinition.create(MapQueryOperations.M_MAP_BI, "mapper", BiFunction.class);
    }
