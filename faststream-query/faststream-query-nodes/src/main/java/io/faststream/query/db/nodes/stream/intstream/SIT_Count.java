...
public class SIT_Count extends TerminalQueryOperationNode implements IntStreamVisitable {

    private static final long serialVersionUID = 1L;

    public SIT_Count(QueryOperationNode parent, StreamContext context) {
        super(parent);
        context.consume();
    }
