...
public class SLT_SummaryStatistics extends TerminalQueryOperationNode implements LongStreamVisitable {

    private static final long serialVersionUID = 1L;

    public SLT_SummaryStatistics(QueryOperationNode parent, StreamContext context) {
        super(parent);
        context.consume();
    }
