...
public class MV_Entries extends AbstractCollectionView implements MapViewVisitable {

    private static final long serialVersionUID = 1L;

    public MV_Entries(QueryOperationNode parent) {
        super(parent);
    }

    public QueryOperationNodeDefinition getOperationPackage() {
        return QueryOperationNodeDefinition.create(MapQueryOperations.M_VIEW_ENTRIES);
    }
