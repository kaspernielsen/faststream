...
public class CV_SortedDescending extends AbstractCollectionView implements CollectionViewVisitable {

    private static final long serialVersionUID = 1L;

    public CV_SortedDescending(QueryOperationNode parent) {
        super(parent);
    }

    public QueryOperationNodeDefinition getOperationPackage() {
        return QueryOperationNodeDefinition.create(CollectionQueryOperations.C_SORTED_NATURAL_REVERSE);
    }
