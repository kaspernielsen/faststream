...
public class SI_AsDoubleStream extends AbstractDoubleStream implements IntStreamVisitable {

    private static final long serialVersionUID = 1L;

    public SI_AsDoubleStream(QueryOperationNode parent, StreamContext context) {
