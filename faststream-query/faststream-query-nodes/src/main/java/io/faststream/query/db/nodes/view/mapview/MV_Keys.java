...
public class MV_Keys extends AbstractCollectionView implements MapViewVisitable {

    private static final long serialVersionUID = 1L;

    public MV_Keys(QueryOperationNode parent) {
        super(parent);
    }

    public QueryOperationNodeDefinition getOperationPackage() {
        return QueryOperationNodeDefinition.create(MapQueryOperations.M_VIEW_KEYS);
    }
