...
public class SD_Limit extends AbstractDoubleStream implements DoubleStreamVisitable {

    private static final long serialVersionUID = 1L;

    private final long maxSize;

    public SD_Limit(QueryOperationNode parent, StreamContext context, long maxSize) {
