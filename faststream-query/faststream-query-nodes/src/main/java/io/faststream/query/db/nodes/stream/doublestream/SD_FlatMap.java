...
public class SD_FlatMap extends AbstractDoubleStream implements DoubleStreamVisitable {

    private static final long serialVersionUID = 1L;

    private final DoubleFunction mapper;

    public SD_FlatMap(QueryOperationNode parent, StreamContext context, DoubleFunction mapper) {
    ...
    public QueryOperationNodeDefinition getOperationPackage() {
        return QueryOperationNodeDefinition.create(CollectionQueryOperations.C_FLAT_MAP_TO_DOUBLE, "mapper", DoubleFunction.class);
    }
