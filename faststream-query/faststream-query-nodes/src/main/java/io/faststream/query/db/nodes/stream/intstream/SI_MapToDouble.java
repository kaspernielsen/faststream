...
public class SI_MapToDouble extends AbstractDoubleStream implements IntStreamVisitable {

    private static final long serialVersionUID = 1L;

    private final IntToDoubleFunction mapper;

    public SI_MapToDouble(QueryOperationNode parent, StreamContext context, IntToDoubleFunction mapper) {
    ...
    public QueryOperationNodeDefinition getOperationPackage() {
        return QueryOperationNodeDefinition.create(CollectionQueryOperations.C_MAP_TO_DOUBLE, "mapper", IntToDoubleFunction.class);
    }
