...
public class CV_Sorted extends AbstractCollectionView implements CollectionViewVisitable {

    private static final long serialVersionUID = 1L;

    private final Comparator comparator;

    public CV_Sorted(QueryOperationNode parent, Comparator comparator) {
        super(parent);
