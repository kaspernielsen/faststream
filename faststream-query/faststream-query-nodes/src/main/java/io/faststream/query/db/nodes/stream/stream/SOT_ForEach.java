...
public class SOT_ForEach extends TerminalQueryOperationNode implements StreamVisitable {

    private static final long serialVersionUID = 1L;

    private final Consumer action;

    public SOT_ForEach(QueryOperationNode parent, StreamContext context, Consumer action) {
        super(parent);
    ...
    public QueryOperationNodeDefinition getOperationPackage() {
        return QueryOperationNodeDefinition.create(CollectionQueryOperations.CT_FOR_EACH, "action", Consumer.class);
    }
