...
public class SI_FlatMap extends AbstractIntStream implements IntStreamVisitable {

    private static final long serialVersionUID = 1L;

    private final IntFunction mapper;

    public SI_FlatMap(QueryOperationNode parent, StreamContext context, IntFunction mapper) {
    ...
    public QueryOperationNodeDefinition getOperationPackage() {
        return QueryOperationNodeDefinition.create(CollectionQueryOperations.C_FLAT_MAP_TO_INT, "mapper", IntFunction.class);
    }
