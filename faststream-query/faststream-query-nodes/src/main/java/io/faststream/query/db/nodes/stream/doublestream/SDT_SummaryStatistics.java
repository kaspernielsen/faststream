...
public class SDT_SummaryStatistics extends TerminalQueryOperationNode implements DoubleStreamVisitable {

    private static final long serialVersionUID = 1L;

    public SDT_SummaryStatistics(QueryOperationNode parent, StreamContext context) {
        super(parent);
        context.consume();
    }

    public QueryOperationNodeDefinition getOperationPackage() {
        return QueryOperationNodeDefinition.create(CollectionQueryOperations.CT_MATH_SUMMARY_STATISTICS);
    }
    ...
    public void accept(DoubleStreamVisitable.DoubleStreamVisitor visitor) {
        visitor.summaryStatistics(this);
    }
}
