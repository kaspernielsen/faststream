...
public class SDT_AnyMatch extends TerminalQueryOperationNode implements DoubleStreamVisitable {

    private static final long serialVersionUID = 1L;

    private final DoublePredicate doublePredicate;

    public SDT_AnyMatch(QueryOperationNode parent, StreamContext context, DoublePredicate doublePredicate) {
        super(parent);
    ...
    public QueryOperationNodeDefinition getOperationPackage() {
        return QueryOperationNodeDefinition.create(CollectionQueryOperations.CT_MATCH_ANY, "doublePredicate", DoublePredicate.class);
    }
