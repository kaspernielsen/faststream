...
public class SL_MapToInt extends AbstractIntStream implements LongStreamVisitable {

    private static final long serialVersionUID = 1L;

    private final LongToIntFunction mapper;

    public SL_MapToInt(QueryOperationNode parent, StreamContext context, LongToIntFunction mapper) {
    ...
    public QueryOperationNodeDefinition getOperationPackage() {
        return QueryOperationNodeDefinition.create(CollectionQueryOperations.C_MAP_TO_INT, "mapper", LongToIntFunction.class);
    }
