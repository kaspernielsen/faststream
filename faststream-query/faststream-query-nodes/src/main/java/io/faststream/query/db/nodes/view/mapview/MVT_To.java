...
public class MVT_To extends TerminalQueryOperationNode implements MapViewVisitable {

    private static final long serialVersionUID = 1L;

    private final Class type;

    public MVT_To(QueryOperationNode parent, Class type) {
        super(parent);
        this.type = Objects.requireNonNull(type, "type is null");
    }

    public QueryOperationNodeDefinition getOperationPackage() {
        return QueryOperationNodeDefinition.create(MapQueryOperations.MT_TO_TYPE, "type", Class.class);
    }
