...
public class SOT_ReduceCombiner extends TerminalQueryOperationNode implements StreamVisitable {
    ...
    public SOT_ReduceCombiner(QueryOperationNode parent, StreamContext context, Object identity, BiFunction accumulator, BinaryOperator combiner) {
        super(parent);
    ...
    public QueryOperationNodeDefinition getOperationPackage() {
        return QueryOperationNodeDefinition.create(CollectionQueryOperations.CT_REDUCE_FUSED, "identity", Object.class, "accumulator", BiFunction.class, "combiner", BinaryOperator.class);
    }
    ...
    public BiFunction getAccumulator() {
        return accumulator;
    }

    public BinaryOperator getCombiner() {
        return combiner;
    }

    public void accept(StreamVisitable.StreamVisitor visitor) {
        visitor.reduceCombiner(this);
    }
}
