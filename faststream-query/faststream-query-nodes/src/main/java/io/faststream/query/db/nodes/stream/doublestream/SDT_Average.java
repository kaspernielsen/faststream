...
public class SDT_Average extends TerminalQueryOperationNode implements DoubleStreamVisitable {

    private static final long serialVersionUID = 1L;

    public SDT_Average(QueryOperationNode parent, StreamContext context) {
        super(parent);
        context.consume();
    }

    public QueryOperationNodeDefinition getOperationPackage() {
        return QueryOperationNodeDefinition.create(CollectionQueryOperations.CT_MATH_ARITHMETIC_MEAN);
    }
