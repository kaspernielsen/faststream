...
public class SDT_Iterator extends TerminalQueryOperationNode implements DoubleStreamVisitable {

    private static final long serialVersionUID = 1L;

    public SDT_Iterator(QueryOperationNode parent, StreamContext context) {
        super(parent);
        context.consume();
    }
