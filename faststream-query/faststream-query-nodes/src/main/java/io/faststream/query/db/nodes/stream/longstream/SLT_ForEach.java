...
public class SLT_ForEach extends TerminalQueryOperationNode implements LongStreamVisitable {

    private static final long serialVersionUID = 1L;

    private final LongConsumer action;

    public SLT_ForEach(QueryOperationNode parent, StreamContext context, LongConsumer action) {
        super(parent);
    ...
    public QueryOperationNodeDefinition getOperationPackage() {
        return QueryOperationNodeDefinition.create(CollectionQueryOperations.CT_FOR_EACH, "action", LongConsumer.class);
    }
