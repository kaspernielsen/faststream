...
public class MVT_IsEmpty extends TerminalQueryOperationNode implements MapViewVisitable {

    private static final long serialVersionUID = 1L;

    public MVT_IsEmpty(QueryOperationNode parent) {
        super(parent);
    }

    public QueryOperationNodeDefinition getOperationPackage() {
        return QueryOperationNodeDefinition.create(MapQueryOperations.MT_IS_EMPTY);
    }
