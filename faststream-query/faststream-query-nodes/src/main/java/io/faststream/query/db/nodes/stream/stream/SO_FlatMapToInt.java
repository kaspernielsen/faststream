...
public class SO_FlatMapToInt extends AbstractIntStream implements StreamVisitable {

    private static final long serialVersionUID = 1L;

    private final Function mapper;

    public SO_FlatMapToInt(QueryOperationNode parent, StreamContext context, Function mapper) {
    ...
    public QueryOperationNodeDefinition getOperationPackage() {
        return QueryOperationNodeDefinition.create(CollectionQueryOperations.C_FLAT_MAP_TO_INT, "mapper", Function.class);
    }
