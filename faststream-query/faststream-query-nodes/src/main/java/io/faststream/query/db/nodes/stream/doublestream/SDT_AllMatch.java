...
public class SDT_AllMatch extends TerminalQueryOperationNode implements DoubleStreamVisitable {

    private static final long serialVersionUID = 1L;

    private final DoublePredicate doublePredicate;

    public SDT_AllMatch(QueryOperationNode parent, StreamContext context, DoublePredicate doublePredicate) {
        super(parent);
    ...
    public QueryOperationNodeDefinition getOperationPackage() {
        return QueryOperationNodeDefinition.create(CollectionQueryOperations.CT_MATCH_ALL, "doublePredicate", DoublePredicate.class);
    }
