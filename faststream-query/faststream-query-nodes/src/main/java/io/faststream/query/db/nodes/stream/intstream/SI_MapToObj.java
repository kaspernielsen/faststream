...
public class SI_MapToObj extends AbstractStream implements IntStreamVisitable {

    private static final long serialVersionUID = 1L;

    private final IntFunction mapper;

    public SI_MapToObj(QueryOperationNode parent, StreamContext context, IntFunction mapper) {
    ...
    public QueryOperationNodeDefinition getOperationPackage() {
        return QueryOperationNodeDefinition.create(CollectionQueryOperations.C_MAP_TO_OBJECT, "mapper", IntFunction.class);
    }
