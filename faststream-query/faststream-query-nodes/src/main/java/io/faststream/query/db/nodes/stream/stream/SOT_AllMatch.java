...
public class SOT_AllMatch extends TerminalQueryOperationNode implements StreamVisitable {

    private static final long serialVersionUID = 1L;

    private final Predicate predicate;

    public SOT_AllMatch(QueryOperationNode parent, StreamContext context, Predicate predicate) {
        super(parent);
    ...
    public QueryOperationNodeDefinition getOperationPackage() {
        return QueryOperationNodeDefinition.create(CollectionQueryOperations.CT_MATCH_ALL, "predicate", Predicate.class);
    }
