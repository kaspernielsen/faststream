...
public class SO_FlatMapToLong extends AbstractLongStream implements StreamVisitable {

    private static final long serialVersionUID = 1L;

    private final Function mapper;

    public SO_FlatMapToLong(QueryOperationNode parent, StreamContext context, Function mapper) {
    ...
    public QueryOperationNodeDefinition getOperationPackage() {
        return QueryOperationNodeDefinition.create(CollectionQueryOperations.C_FLAT_MAP_TO_LONG, "mapper", Function.class);
    }
