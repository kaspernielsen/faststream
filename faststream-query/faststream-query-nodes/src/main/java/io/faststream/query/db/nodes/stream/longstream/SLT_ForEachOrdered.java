...
public class SLT_ForEachOrdered extends TerminalQueryOperationNode implements LongStreamVisitable {

    private static final long serialVersionUID = 1L;

    private final LongConsumer action;

    public SLT_ForEachOrdered(QueryOperationNode parent, StreamContext context, LongConsumer action) {
        super(parent);
    ...
    public QueryOperationNodeDefinition getOperationPackage() {
        return QueryOperationNodeDefinition.create(CollectionQueryOperations.CT_FOR_EACH_ORDERED, "action", LongConsumer.class);
    }
