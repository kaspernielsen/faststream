...
public class SO_FlatMap extends AbstractStream implements StreamVisitable {

    private static final long serialVersionUID = 1L;

    private final Function mapper;

    public SO_FlatMap(QueryOperationNode parent, StreamContext context, Function mapper) {
    ...
    public QueryOperationNodeDefinition getOperationPackage() {
        return QueryOperationNodeDefinition.create(CollectionQueryOperations.C_FLAT_MAP_TO_OBJECT, "mapper", Function.class);
    }
