...
public class SIT_AnyMatch extends TerminalQueryOperationNode implements IntStreamVisitable {

    private static final long serialVersionUID = 1L;

    private final IntPredicate intPredicate;

    public SIT_AnyMatch(QueryOperationNode parent, StreamContext context, IntPredicate intPredicate) {
        super(parent);
    ...
    public QueryOperationNodeDefinition getOperationPackage() {
        return QueryOperationNodeDefinition.create(CollectionQueryOperations.CT_MATCH_ANY, "intPredicate", IntPredicate.class);
    }
