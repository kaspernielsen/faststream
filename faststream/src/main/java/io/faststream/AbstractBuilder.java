...
/**
 * An abstract builder for data structures uses dynamic code generation to generate highly efficient code.
 *
...
public abstract class AbstractBuilder {
     ...
     *
     * <pre>
     * builder.addCodeWriter(System.out);
     * </pre>
     *
     * @param stream
     *            the print stream
     ...
     */
    public AbstractBuilder addCodeWriter(PrintStream stream) {
     ...
     */
    public AbstractBuilder addCodeWriter(PrintWriter writer) {
    ...
    /**
     * The default package as set by {@link #setPackage(Package)} or {@link #setPackage(String)}. Or {@code null} if no
     * default package has been set.
     *
     ...
     */
    public AbstractBuilder setClassLoaderParent(ClassLoader parentClassLoader) {
     ...
     * @return this configuration
     */
    public AbstractBuilder setPackage(String defaultPackage) {
     ...
     * generated classes. For example, an IDE can be set up to point to the source path specified by this method.
     * <p>
     * The placement of files are relative to the specified source path. Matching any package naming scheme set by
     * {@link #setPackage(String)}.
     *
     * @param directory
     *            the output directory
     * @return this configuration
     */
    public AbstractBuilder setSourcePath(Path directory) {
     ...
     * @return this configuration
     */
    public AbstractBuilder setSourcePath(String directory) {
        return setSourcePath(directory == null ? null : Paths.get(directory));
    }
}
//
// // Future versions will also allow reusing of streams (breaking the spec slightly) to allow even more aggressively
// // optimizations.
// public void enableReusableStreams() {
// // Maa kunne specificere min egen StreamContext.
// // Som siger at den kan genbruges
// }
//
// // Reuseable
...
// * @return this configuration
// */
// public final AbstractBuilder setDefaultPackage(Package defaultPackage) {
